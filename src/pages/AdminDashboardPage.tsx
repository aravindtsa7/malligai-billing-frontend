...
const ADMIN_MODULES: DashboardModule[] = [
  ...
  },
  {
    ...
    description: 'Manage shop products, barcodes, units, and retail/function pricing rates.',
    icon: '📦',
    status: 'Coming Soon',
  },
  {
    ...
    <div className="dashboard-page">
      <div className="dashboard-welcome">
        ...
        <p className="dashboard-subtitle">
          Welcome back, <strong>{user?.username}</strong>. Select a module below to get started.
        </p>
      </div>
